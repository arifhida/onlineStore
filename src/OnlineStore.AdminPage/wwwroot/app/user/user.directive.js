            ...
            return {
                ...
                link: function ($scope, element, attrs, ngModel) {
                    ngModel.$asyncValidators.userexist = function (username) {
                        return $http.post('http://localhost:58969/api/Customer/CheckUserName', JSON.stringify(username), { headers: { 'Content-Type': 'application/json' } })
            ...
            return {
                ...
                link: function ($scope, element, attrs, ngModel) {
                    ngModel.$asyncValidators.emailexist = function (email) {
                        return $http.post('http://localhost:58969/api/Customer/CheckEmail', JSON.stringify(email), { headers: { 'Content-Type': 'application/json' } })
                        .then(function resolved() {
                            return true;
                        }, function rejected() {
